        ...
        <section className="py-20 bg-gradient-to-b from-background to-muted/20 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-6 relative">
            ...
            <motion.div 
              ...
              variants={containerVariants}
            >
              {/* Step 1 Card - Enhanced */}
              <motion.div
                variants={cardVariants}
                whileHover="hover"
                className="relative"
              >
                <Card className="relative overflow-hidden border-2 border-transparent bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <CardContent className="relative p-8 text-center">
                    {/* Enhanced number badge with pulse animation */}
                    <motion.div 
                    ...
                    >
                      <Badge className="bg-gradient-to-r from-yellow-100 to-orange-100 text-yellow-800 dark:from-yellow-900/30 dark:to-orange-900/30 dark:text-yellow-400 border-yellow-200 dark:border-yellow-700 px-4 py-1 font-medium">
              ...
              {/* Step 2 Card - Enhanced */}
              <motion.div
                variants={cardVariants}
                whileHover="hover"
                className="relative"
              >
                <Card className="relative overflow-hidden border-2 border-dashed border-muted-foreground/20 bg-gradient-to-br from-white to-gray-50/30 dark:from-gray-900 dark:to-gray-800/30 shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardContent className="relative p-8 text-center">
                    {/* Enhanced number badge */}
                    <motion.div 
                      className="w-20 h-20 bg-gradient-to-br from-gray-300 to-gray-400 dark:from-gray-600 dark:to-gray-700 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg"
                      whileHover={{ scale: 1.05 }}
                      transition={{ type: "spring", stiffness: 300, damping: 20 }}
                    >
                    ...
                    <motion.div
                      ...
                      transition={{ delay: 0.5, type: "spring", stiffness: 200 }}
                    >
                      <Badge variant="outline" className="border-muted-foreground/30 text-muted-foreground px-4 py-1 font-medium">
                  ...
                  {/* Subtle floating dots for pending state */}
                  <div className="absolute top-4 right-4">
                    ...
                    >
                      ...
                      <div className="w-2 h-2 bg-muted-foreground rounded-full" style={{ animationDelay: "0.2s" }} />
                      <div className="w-2 h-2 bg-muted-foreground rounded-full" style={{ animationDelay: "0.4s" }} />
                    </motion.div>
                  </div>
                </Card>
              </motion.div>
            ...
            >
              <motion.div variants={cardVariants} whileHover="hover">
                <Card className="h-full text-center hover:shadow-lg transition-all duration-300 border-blue-100 dark:border-blue-900/20">
              ...
              <motion.div variants={cardVariants} whileHover="hover">
                <Card className="h-full text-center hover:shadow-lg transition-all duration-300 border-green-100 dark:border-green-900/20">
                  <CardContent className="p-6">
                    <motion.div 
              ...
              <motion.div variants={cardVariants} whileHover="hover">
                <Card className="h-full text-center hover:shadow-lg transition-all duration-300 border-purple-100 dark:border-purple-900/20">
                  <CardContent className="p-6">
                    <motion.div 
